...
if ([MyNSObject saveObjectToURL:[NSURL URLWithString:@"/Users/USERNAME/Desktop/testEncryptedReduced.txt"] reducedFileSize:YES encryptionString:@"YOUR_PASSWORD" saltString:salt]) {
	// Success
	}
else {
	// Failure
